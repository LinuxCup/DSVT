...
cfg_file = "/home/zhenghu/DeepLearning/DSVT/tools/cfgs/dsvt_models/dsvt_plain_1f_onestage_zhito_5w_150epoch_lr002_range.yaml"
...
with torch.no_grad():
    ...
    base_name = "combine3modules_dynamic_shape_noscatter_zhito"
    ts_path = f"{base_name}.ts"
    onnx_path = f"{base_name}.onnx"
