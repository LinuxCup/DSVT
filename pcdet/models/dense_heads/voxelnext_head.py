...
class VoxelNeXtHead(nn.Module):
    ...
    def forward(self, data_dict):
        self.sparse_shape = [264,384]
        # self.sparse_shape = [384,264]
        data_dict['voxel_coords'] = torch.cat([data_dict['voxel_coords'][...,0].unsqueeze(1), data_dict['voxel_coords'][...,2:]],dim=1)
        input_sp_tensor = spconv.SparseConvTensor(
            features=data_dict['pillar_features'],
